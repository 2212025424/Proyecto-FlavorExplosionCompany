<%-- 
    Document   : panel_producto_apertura
    Created on : 14/07/2020, 12:35:42 AM
    Author     : ACER
--%>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <%
                    ...
                    if (partes[partes.length - 1].equals("v_producto_visualizar.jsp")) { %>
                <div class="btn-group sticky-top">
                    <a class="btn btn-primary active" href="v_producto_interpolar.jsp">
                    ...
                    <a class="btn btn-primary active" href="v_producto_visualizar.jsp">
                ...
                <a class="btn btn-danger" href="v_producto_visualizar.jsp">
