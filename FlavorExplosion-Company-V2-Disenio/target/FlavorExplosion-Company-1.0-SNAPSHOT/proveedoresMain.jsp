<%-- 
    Document   : proveedoresMain
    Created on : 6/07/2020, 05:59:41 PM
    Author     : ACER
--%>
<%
    String titulo = "Inicio proveedores company || Proveedores Empresas";
%>
...
<div class="container">
    ...
    <div class="contenedor">
        ...
        <h4>Opciones en proveedores</h4>
        <h6>Registrar, eliminar, atualizar los proveedores</h6>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 ml-auto">
                <!--Nos permite agregar invcar la modal de formulario-->
        ...
        <!--Incluimos el formulario de registro contenido en una modal-->
        <%@include file="formulario_proveedor.jsp"%>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td class="encabezado-tabla" colspan="3">Registrados 12</td> 
                </tr>
            </table>
        </div>
    </div>
